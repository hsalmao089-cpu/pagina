...
`video/` tem um Reels de 33 s da oferta de Claude Code ilimitado, com a
tipografia desta página e uma paleta vibrante de campanha, feita para o feed.
É um projeto Remotion à parte, com `package.json` próprio — a página continua
sem build.
